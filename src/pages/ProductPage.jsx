...
<section className={styles.pdp}>
      ...
      <div className={styles.details}>
        <h1>{product.name}</h1>
        <p className={styles.price}>${Number(product.pricePerUnit).toFixed(2)}</p>
        ...
        <div className={styles.section}>
          ...
          className={styles.select}
            ...
            disabled={isOutOfStock || !product.variants?.length || product.variants.length === 0}
        ...
        <div className={styles.section}>
          ...
          <div className={styles.qtyRow}>
            <button className={styles.qtyBtn} type="button" onClick={handleDecrement} disabled={isOutOfStock || qty <= 1}>
              -
            </button>
        ...
        <button
          ...
          onClick={() => {
            // Phase 3 next step: wire to cart state
